...
reg		[99:0]			video_de_delay;

reg[DATA_WIDTH - 1:0]  vout_data_r;

//assign read_en = video_de && ( x_cnt <= 511 );

assign read_en = video_de ;

//assign read_en = video_de_delay[99];
...
begin
	if(rst == 1'b1)
		video_de_delay 	<= 100'b0;
	else
		video_de_delay	<=	{video_de_delay[98:0],video_de};	
end
